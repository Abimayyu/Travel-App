                  ...
                  <div class="col-md-10">
                     <div class="card card-transparent shadow-none d-flex justify-content-center mb-0 auth-card">
                        <div class="card-body">
                           ...
                           <p class="text-center">Masuk untuk terhubung dengan akun Anda</p>
                           <form method="POST" action="{{ url('api/login') }}" id="login-form">
                            @csrf
                              <div class="row">
                                 <div class="col-lg-12">
                              ...
                              <p class="mt-3 text-center">
                                 Belum punya akun? <a href="{{ route('register') }}" class="text-underline">Daftarkan sekarang.</a>
                              </p>
                           </form>
                        </div>
                     </div>
   ...
   <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    ...
    <script>
        document.getElementById('login-form').addEventListener('submit', function(event) {
            ...
            // Sending API request using Axios
